...
try
{
	$template = $signer->unsign($request->get('signedTemplate'), 'wishlist.main');
	$paramString = $signer->unsign($request->get('signedParams'), 'wishlist.main');
}
